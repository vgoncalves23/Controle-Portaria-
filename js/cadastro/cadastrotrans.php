...
if(count($_POST) > 0) {
    ...
    if(empty($nome)) {
      ...
      <?php
        ...
        $sql_code = "INSERT INTO port (nome, cnpj, telefone, email, endereco, placa, modelo, cor, datae) 
        VALUES ('$nome', '$cnpj','$telefone','$email','$endereco','$placa', '$modelo','$cor',now())";
...
<body>
    ...
    <div class="col-md-6 mx-auto p-0">
		<div class="card">
        <h3 style="color: black;">Cadastro Transportadora</h3>	
        <div class="login-box">
		...
		<div class="login-space">
            ...
            <div class="group">
				...
				<div class="group">
					...
					<input id="pass" value="<?php if(isset($_POST['cnpj'])) echo $_POST['cnpj']; ?>" name="cnpj" type="text" class="input">
				</div>
                <div class="group">
                ...
                <div class="group">
					...
					<input id="pass" class="input"   value="<?php if(isset($_POST['endereco'])) echo $_POST['endereco']; ?>" name="endereco" type="text">
				</div>
