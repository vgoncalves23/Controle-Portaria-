...
require './vendor/autoload.php';
        ...
        try {
            ...
            $mail->Body = "Olá $nome, sua solicitação de empréstimo de um notebook $modelo foi realizado na data $dataini.<br> Data prevista de devolução: <b> $datafim </b> <br>** . <b>IMPORTANTE:</b> esta é uma mensagem automática e não deve ser respondida. ";
